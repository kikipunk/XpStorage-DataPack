tellraw @a ["",{"text":"XpStorage DataPack successfully loaded !! ","color":"dark_aqua","hoverEvent":{"action":"show_text","value":"By Daminator4113 and Kikipunk"}},{"text":"Version 1.0!!","color":"gold","hoverEvent":{"action":"show_text","value":"By Daminator4113 and Kikipunk"}}]
