...
execute as @e[type=minecraft:armor_stand,tag=xs_hopper] at @s positioned ~ ~1.25 ~0.75 if block ~ ~ ~ minecraft:hopper{Items:[{Slot:0b,id:"minecraft:potion",Count:1b,tag:{CustomPotionColor:9436928}}]} store result score @s xs_points run data get block ~ ~-0.1 ~ Items[0].tag.xppoints
